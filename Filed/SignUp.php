    ...
    elseif (strlen($Password) < 8 || strlen($Password) > 16)
        ...
        if (mysqli_connect_errno()) {
            ...
            if (count($array)) {
                ...
                {
                    if($Username == $array[$i]['username'] && $Email == $array[$i]['email'])
                    {

                        $error = "<p>Your Account is valid</p>";
                        exit();
                    }
                    else{}
//                    else {
...
//                        $insert = "INSERT INTO user(id,username,email,password,vkey,verified) VALUES('$id','$Username','$Email','$Password','$vkey','$verified')";
...
//                            $massage .= "<br>";
//                            $massage .= "<a style='alignment: left font-size: large ' href ='verify.php?vkey=$vkey'>REGISTER YOUR ACCOUNT</a>";
//                            $massage .= "<br>";
...
//                            $headers = "From: wajeed.mabroukeh@gmail.com \r\n";
